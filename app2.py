...
if S == True:
	...
	st.info("Vous pourrez voir l'évolution au cours du temps de chacune des données. Parmi les données, on retrouve le prix, la production, les données météos(température(minimale et maximale) en °C, précipitations en mm, durée de l'ensoleillement en min, vitesse du vent en km/h). Une fois la catégorie choisie, il suffit de cliquer sur les données correspndant à la catégorie  que vous aurez choisi, pour voir la représentation graphique.")
	tache = st.selectbox("Choisir les données à visualiser:",["prix au kilo","production","Température minimale en °C","Température maximale en °C","précipitations en mm","Durée de l'ensoleillement en min","Vitesse du vent en km/h"])

	if tache == "prix au kilo":
		if st.button("prix au kilo"):
	...
	if tache == "Température minimale en °C":
		if st.button("Température minimale en °C"):
	...
	if tache == "Température maximale en °C":
		if st.button("Température maximale en °C"):
	...
	if tache == "précipitations en mm":
		if st.button("précipitations en mm"):
	...
	if tache == "Durée de l'ensoleillement en min":
		if st.button("Durée de l'ensoleillement en min"):
	...
	if tache == "Vitesse du vent en km/h":
		if st.button("Vitesse du vent en km/h"):
